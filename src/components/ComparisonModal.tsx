...
export default function ComparisonModal({ platformIds, platforms, onClose }: ComparisonModalProps) {
  ...
  return (
    <>
      ...
      />
      <div
        className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[500] bg-white rounded-2xl shadow-2xl w-[95vw] max-w-[1200px] max-h-[95vh] overflow-hidden animate-[modalIn_0.3s_ease]"
        ...
        <div className="p-6 overflow-y-auto max-h-[calc(95vh-140px)]">
          ...
          <div className="grid gap-2" style={{ gridTemplateColumns: `200px repeat(${selectedPlatforms.length}, 1fr)` }}>
            ...
            {scoreFeatures.map(feature => (
              <>
                <div key={`label-${feature}`} className="bg-[#F5F5F5] px-4 py-3 rounded-lg flex items-center">
